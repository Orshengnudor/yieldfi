...
export const AGENT_REPUTATION_ADDRESS   = "0x2f78abfCEAf61F0F6fA2a60738CaF15216ab0dE3" as `0x${string}`;
export const AGENT_EXECUTOR_ADDRESS     = "0xCFEeC6da527b0aF4ef2D69e953eAc8aF44124900" as `0x${string}`;
export const STRATEGY_MARKETPLACE_ADDRESS = "0x8c967Fc818Ab56CADAfe2b810Df34954270FaFE2" as `0x${string}`;
